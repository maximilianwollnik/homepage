...
describe('homepage.routes', function() {
  ...
  describe('provides all routes', function() {
    ...
    it('and all routes must be loaded correctly', inject(function($route) {
      ...
      expect($route.routes['/disclaimer'].templateUrl).toEqual(
          'app/components/disclaimer/disclaimerView.html');
      expect($route.routes['/work'].templateUrl).toEqual(
          'app/components/work/workView.html');
      expect($route.routes['/home'].templateUrl).toEqual(
