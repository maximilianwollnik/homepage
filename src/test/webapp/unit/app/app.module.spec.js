describe(
    ...
    function() {
      ...
      describe('loads the main app', function() {
        it('and the default language should be set to de_DE', inject(function(
            $translate) {
      ...
      describe(
          'is responsible for the view overview',
          function() {
            var element, scope;
            ...
            beforeEach(inject(function(_$compile_, _$rootScope_, _$location_) {
              ...
              scope = $rootScope.$new();
              // prepare scope in which your directive should be
              // used
              // ...
              element = angular
                  .element('<h4 ng-bind-html="\'HOME.HEADLINE.PRE\' | translate"></h4><h1 ng-bind-html="\'HOME.HEADLINE.TITLE\' | translate"></h1>');
              $compile(element)(scope);
              scope = element.scope();
              return scope.$apply();
            }));

            it('and the english translation should be loaded', inject(function(
                $compile) {
              expect(element.text()).toBe(
                  'Hallo, mein Name istMaximilian Wollnik');
            }));
