    ...
    function() {
      ...
      describe('should render work when user navigates to /work', function() {
                  ...
                  .then(
                      function() {
                        ...
                        expect(element(
                            ...
                            .getText()).not.toMatch('WORK.HEADLINE.PRE');
                        element(by.css('img[src*="assets/img/de.png"]'))
                            .click();
                        expect(element.all(by.css('.container')).getText())
                            .toMatch('Muster');
                        expect(element(by.css('#workwrap')).isPresent()).toBe(
                            true);
                      })
            });
        ...
        it('and 2 samples must be available', function() {
          browser.waitForAngular();
          expect(element.all(by.css('.embed-responsive-16by9')).count())
              .toEqual(2);
        });
      });
