...
describe(
    ...
    function() {
      ...
      function openModal() {
        element.all(by.css('#mail')).getCssValue('display').then(
      ...
      describe(
          'should render social when user navigates to /home',
          function() {

            it('and the mail modal be available in German when opened',
                function() {
                  ...
                  browser.executeScript('window.scrollTo(0,10000);').then(
                      function() {
                        ...
                        expect(element(by.css('#mailModalLabel')).getText())
                            .toMatch('Schreiben Sie mir eine Mail');
            ...
            it(
                'and the mail modal must be invalid when it is submitted empty',
                function() {
                  element(by.css('img[src*="assets/img/de.png"]')).click();
                  browser
                      ...
                      .then(
                          function() {
                            ...
                            expect(
                                element(
                                    by
                                        .css('span[data-ng-show*="submitted && mailForm.name.$error.required"]'))
                                    .isDisplayed()).toBe(false);
                            expect(
                                element(
                                    by
                                        .css('span[data-ng-show*="submitted && mailForm.email.$error.required"]'))
                                    .isDisplayed()).toBe(false);
                            expect(
                                element(
                                    by
                                        .css('span[data-ng-show*="submitted && mailForm.body.$error.required"]'))
                                    .isDisplayed()).toBe(false);
                            element(by.css('button[class*="btn btn-primary"]'))
                                .click();
                            expect(
                                element(
                                    by
            ...
            it(
                'and the mail modal must be resetted after closed invalid',
                function() {
                  element(by.css('img[src*="assets/img/de.png"]')).click();
                  browser
                      .executeScript('window.scrollTo(0,10000);')
            ...
            it(
                'and the mail modal must be invalid when it is submitted with wrong email',
                function() {
                  element(by.css('img[src*="assets/img/de.png"]')).click();
                  browser
                      .executeScript('window.scrollTo(0,10000);')
                      .then(
                          function() {
                            ...
                            element(by.css('input[name*="name"]')).sendKeys(
                                'name');
                            element(by.css('input[name*="email"]')).sendKeys(
                                'name');
                            element(by.css('textarea[name*="body"]')).sendKeys(
                                'name');
                            ...
                            expect(
                                element(
                                    by
                                        .css('span[data-ng-show*="submitted && mailForm.$error.email"]'))
                                    .isDisplayed()).toBe(true);
                            expect(
                                element(
                                    by
